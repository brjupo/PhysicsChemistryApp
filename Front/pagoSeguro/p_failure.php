...
<head>
  ...
  <title>Kaanbal - Payment Failure</title>
...
<body>
  ...
  // 2.5.- Dado que esta es la pantalla de FAILURE, y basados en la tabla payment_status, market_pay_status = 3 [FAILURE]
  ...
  // 3.2.- Crear el html del correo en una función hasta abajo de este archivo. enviarMailPagoFallado
  ...
  if ($errorDetected == 0) {
    enviarMail($verdaderoCliente, "Error en su pago - Kaanbal", enviarMailPagoFallado($verdaderoCliente, $paymentId));
  }
  // 3.3.- Para el caso de pending, preparar el webhook para enviar correo en caso de que el pago haya sido validado
  // 3.4.- Para el caso de failure, enviar correo solo como confirmación del error
  ?>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-10 col-sm-10 col-md-12 col-lg-12 col-xl-12" style="
              background-color: rgba(225, 50, 0, 0.9);
              color: white;
              border-radius: 1vw;
            ">
          ...
          <p class="text-center" style="font-size: medium">
            Tu pago ha sido registrado como fallido. Quizá tu banco no autorizó el pago.
          </p>
          <p style="color: rgba(0, 0, 0, 0)">.</p>
          <p class="text-center" style="font-size: medium">
...
function enviarMailPagoFallado($mail, $paymentIdMail)
{
  return '
<html>
<head>
