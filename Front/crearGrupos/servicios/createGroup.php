...
try {
    ...
    $sql = 'INSERT INTO grupo (id_campus, id_periodo_escolar, id_asignatura, id_profesor, nombre, codigo) VALUES (4, 0, "'.$id_asignatura.'", "'.$id_usuario.'", "'.$nombre_grupo.'", "'.$codigo_grupo.'");';
