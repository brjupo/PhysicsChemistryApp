...
<body>
    ...
    <?php
    //Iniciamos los arreglos, que creo que no utilizaremos
    $alumnos = array();
    $alumnos["matricula"] = array();
    $alumnos["id"] = array();
    $alumnos["tiempoPP"] = array();
    $alumnos["tiempoSP"] = array();
    $alumnos["tiempoE"] = array();
    $alumnos["tiempoSG"] = array();
    /*

                            array_push($alumnos["matricula"], $row[0]);
                            array_push($alumnos["id"], $row[1]);
                            array_push($alumnos["tiempoPP"], 0);
                            array_push($alumnos["tiempoSP"], 0);
                            array_push($alumnos["tiempoE"], 0);
                            array_push($alumnos["tiempoSG"], 0);
    */
    ?>
