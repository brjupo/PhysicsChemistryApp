...
function saveInDDBB() {
  $.ajax({
    ...
    data: {
      ...
      respuesta_correcta: document.getElementById("respuesta_correcta").value.replace(/\\/g, "\\\\"),
      respuesta2: document.getElementById("respuesta2").value.replace(/\\/g, "\\\\"),
      respuesta3: document.getElementById("respuesta3").value.replace(/\\/g, "\\\\"),
      respuesta4: document.getElementById("respuesta4").value.replace(/\\/g, "\\\\"),
      question: document.getElementById("question").value.replace(/\\/g, "\\\\"),
      correct_answer: document.getElementById("correct_answer").value.replace(/\\/g, "\\\\"),
