  ...
  <body>
    ...
    <div id="lections" style="display: none;">
      ...
      <div class="container">
        <div class="row">
          <div
            class="textCenter col-xs-1 col-sm-2 col-md-3 col-lg-4 col-xl-4"
          ></div>
    ...
    <div id="profile">
      ...
      <div class="container" id="avatarActual">
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-2 col-lg-3 col-xl-3"></div>
          <div class="col-xs-10 col-sm-10 col-md-8 col-lg-6 col-xl-6">
            <img src="../CSSsJSs/images/avatar.jpg" class="avatarImg" id="editarAvatar" />
          </div>
          <div class="col-xs-1 col-sm-1 col-md-2 col-lg-3 col-xl-3"></div>
        </div>
      </div>
      ...
      <div class="container ocultarOpciones" id="avatarElegir">
        ...
        <div class="row">
          ...
          <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
            <img
              src="../CSSsJSs/images/avatar10.jpg"
              class="avatarOpciones"
              id="avatar10"
            />
          </div>
          <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
            <img
              src="../CSSsJSs/images/avatar11.jpg"
              class="avatarOpciones"
              id="avatar11"
            />
          </div>
          <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
            <img
              src="../CSSsJSs/images/avatar12.png"
              class="avatarOpciones"
              id="avatar12"
            />
          </div>
