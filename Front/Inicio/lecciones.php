...
<body>
  ...
  function traerLecciones()
  {
    ...
    */
    ...
    $statement = mysqli_prepare($con, "SELECT id_leccion, id_subtema, nombre, orden FROM leccion WHERE id_subtema = ?  ORDER BY orden ASC");
