    ...
    <div class="container">
      <div class="row">
        <div class="textCenter col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          ...
          <p>
            2.- Una vez revisado todo cada símbolo "\" deberá tener su gemelo.
            Ejemplo: La fórmula \\(LaTeX\\) es igual a \\( \\alpha \\)
          </p>
        ...
        >
          ...
          <div class="input-group mb-3">
            <textarea id="pregunta" rows="4" cols="150" wrap="soft">
                AtW3SchoolsyouwillfindfreeWeb-buildingtutorials.AtW3SchoolsyouwillfindfreeWeb-buildingtutorials.AtW3SchoolsyouwillfindfreeWeb-buildingtutorials.AtW3SchoolsyouwillfindfreeWeb-buildingtutorials.AtW3SchoolsyouwillfindfreeWeb-buildingtutorials.AtW3SchoolsyouwillfindfreeWeb-buildingtutorials.AtW3SchoolsyouwillfindfreeWeb-buildingtutorials.
            </textarea>
          </div>
        </div>
      </div>
