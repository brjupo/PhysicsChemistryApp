...
<body>
    ...
    $query = "SELECT * FROM pregunta WHERE id_pregunta IN (149,183,186)"; //WHERE TEMA = 'TEMA' AND SUBTEMA = 'SUBTEMA' AND LECCION = 'LECCION'";     
    $result = mysqli_query($con, $query);
    //contar Numero de elementos
    $query2 = "SELECT count(*) FROM pregunta WHERE id_pregunta IN (149,183,186)"; // WHERE TEMA = 'TEMA' AND SUBTEMA = 'SUBTEMA' AND LECCION = 'LECCION'";
