...
<body>
    ...
    /*---------------------------------------------------------------------------------------- */
    $_SESSION["leccionModoAnuncio"] = $leccion . "-" . "examen";
    ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <p class="text-center">Vuélvete <strong><a href="../../Inicio/perfil.php" style="text-decoration: none;">premium</a></strong> por solo $<?= getTodayPrice() ?>.00 MXN al mes</p>
    ...
    /*---------------------------------- BOTON DE CONTINUAR ---------------------------------- */
    /*---------------------------------------------------------------------------------------- */
    $practica = "examen.php?leccion=" . $leccion;
    ?>
