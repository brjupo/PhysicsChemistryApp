    ...
    <div class="row topMargin">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="progress progressMargin">
          <!-- class="active"-->
          <div class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" <?php echo 'style="width:' . floor(100 * intval($puntos) / intval($totalPreguntas)) . '%"'; ?>>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <h3>You have completed the exam!</h3>
