...
function printSubtopics()
{
  ...
  $statement = mysqli_prepare($con, "SELECT id_leccion, nombre, names FROM leccion WHERE id_subtema = ? ORDER BY orden");
  mysqli_stmt_bind_param($statement, "i", $idSubtema);
  mysqli_stmt_execute($statement);

  mysqli_stmt_store_result($statement);
  mysqli_stmt_bind_result($statement, $id_leccion, $nombre, $name);
  ...
  for ($i = 0; $i < $tamanho; $i++) {
    ...
    printSubtopic($arregloTemas[$i]["id_leccion"], $arregloTemas[$i]["nombre"], $arregloTemas[$i]["name"]);
  }
}

function printSubtopic($ID_Lection, $LectionName, $lectionEnglishName)
{
  echo '
    <div class="container">
      <div class="row">
        <div class="input-group col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
          ...
          <input type="text" class="form-control" id="' . $ID_Lection . '" value="' . $lectionEnglishName . '" />
...
function printInstructions()
{
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <p>
          - Para traducir el nombre de las <strong>lecciones</strong>, edite/introduzca el nombre y de clic en
