...
<head>
    ...
    <script src="editarPreguntaPorLeccion.js"></script>
    ...
    <div class="container">
        <div class="row">
            <div class="input-group input-group-sm col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <input id="idSubtema" type="text" pattern="[0-9.]+" class="form-control" disabled />
            </div>
            <div class="input-group input-group-sm col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-sm">
                ...
                <input id="idLeccion" type="text" pattern="[0-9.]+" class="form-control" />
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="input-group input-group-sm col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <input id="numeroPregunta" type="text" pattern="[0-9.]+" class="form-control" />
            </div>
            <div class="input-group input-group-sm col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
