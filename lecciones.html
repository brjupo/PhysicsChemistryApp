  ...
  <body>
        ...
        <div class="row titulo">
          <div class="textCenter col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xl-1">
            <a href="subtemas.html"
              ><img class="iconoBack" src="icons/FlechaIzq.svg"
            /></a>
          </div>
          <div
            class="textCenter col-xs-11 col-sm-11 col-md-11 col-lg-11 col-xl-11"
          >
    ...
    <div class="container">
      <div id="seccion0" class="row">
        <div
          class="textCenter col-xs-0 col-sm-0 col-md-1 col-lg-2 col-xl-2"
        ></div>

        <div
          class="temaPrincipal1 textCenter col-xs-12 col-sm-12 col-md-10 col-lg-8 col-xl-8"
        >
          <table class="table">
            <tbody>
              <tr>
                ...
                <td width="12%">
                  <a href="preguntas/preguntaSprint.html"
                    ><img class="iconsActive" src="icons/lecciones.svg"
                  /></a>
                </td>
                <td width="12%">
                ...
                <td width="12%">
                  <img class="icons" src="icons/examen.svg" />
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table class="table">
            <tbody>
              <tr>
                ...
                <td width="12%">
                  <a href="preguntas/preguntaSprint.html"
                    ><img class="iconsActive" src="icons/run.svg"
                  /></a>
                </td>
                <td width="12%">
                  <img class="icons" src="icons/examen.svg" />
          ...
          <table class="table">
            <tbody>
              <tr>
                ...
                <td width="12%">
                  <a href="preguntas/preguntaSprint.html"><img class="iconsActive" src="icons/examen.svg" /></a>
                </td>
              </tr>
            </tbody>
          </table>
