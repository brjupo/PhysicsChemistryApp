        ...
        if (strpos($respuestaAlEnviarElMail, "failed") !== false) {
          ...
          if (!is_numeric($gettedTeacherID)) {
            ...
            if ($addedTeacherInTeacher != "success") {
              ...
              $addTeacherInLicenses = new queryToDDBB("INSERT INTO licencia (id_usuario, id_asignatura, vigencia) VALUES (" . intval($gettedTeacherID) . ", 1, '2021-12-31 23:59:59');INSERT INTO licencia (id_usuario, id_asignatura, vigencia) VALUES (id_usuario, 2, '2021-12-31 23:59:59');");
