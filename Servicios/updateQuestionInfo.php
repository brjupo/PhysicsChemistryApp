<?php
    ...
    try {
        ...
        $sql = "UPDATE pregunta SET pregunta = '".$pregunta."', respuesta_correcta = '".$respuesta_correcta."', respuesta2 = '".$respuesta2."', respuesta3 = '".$respuesta3."', respuesta4 = '".$respuesta4."', tipo = '".$tipo."' WHERE id_leccion = '".$leccion."' AND orden = '".$numeroPregunta."'";
