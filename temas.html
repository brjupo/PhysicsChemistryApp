  ...
  <div id="profile" style="display: none;">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-6 col-xl-6">
          <p class="tituloTemasPrincipales textCenter">A01169493</p>
        </div>
        <div class="col-xs-1 col-sm-1 col-md-2 col-lg-3 col-xl-3"></div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-1 col-sm-1 col-md-2 col-lg-3 col-xl-3"></div>
        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-6 col-xl-6">
          <p class="tituloTemasPrincipales textCenter">Energía y transformación 53.3%</p>
        </div>
        <div class="col-xs-1 col-sm-1 col-md-2 col-lg-3 col-xl-3"></div>
      </div>
    </div>
    ...
    <div class="container" id="avatarActual">
      <div class="row">
        <div class="col-xs-1 col-sm-1 col-md-2 col-lg-3 col-xl-3"></div>
        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-6 col-xl-6">
          <img src="images/avatar.jpg" class="avatarImg" id="editarAvatar">
        </div>
        <div class="col-xs-1 col-sm-1 col-md-2 col-lg-3 col-xl-3"></div>
      </div>
    </div>
    ...
    <div class="container ocultarOpciones" id="avatarElegir">
      <div class="row">
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar.jpg" class="avatarOpciones" id="avatar1">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar2.jpg" class="avatarOpciones" id="avatar2">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar3.jpg" class="avatarOpciones" id="avatar3">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar4.jpg" class="avatarOpciones" id="avatar4">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar5.png" class="avatarOpciones" id="avatar5">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar6.png" class="avatarOpciones" id="avatar6">
        </div>
      </div>
      <div class="row">
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar7.jpg" class="avatarOpciones" id="avatar7">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar8.jpg" class="avatarOpciones" id="avatar8">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar9.jpg" class="avatarOpciones" id="avatar9">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar10.jpg" class="avatarOpciones" id="avatar10">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar11.jpg" class="avatarOpciones" id="avatar11">
        </div>
        <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar12.png" class="avatarOpciones" id="avatar12">
        </div>
      </div>
      <div class="row">
        <button type="button" class="btn btn-success" id="guardarAvatar">Guardar</button>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
          <p class="topNumber">1</p>
        </div>
        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
          <img src="images/avatar9.jpg" class="avatarTop">
        </div>
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
          <p class="ID3st">493</p>
        </div>
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
          <p class="IDiamonds">101,234</p>
        </div>
        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xl-1">
          <img src="icons/diamante.svg" class="diamantesTop">
        </div>
        <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 col-xl-1">
        </div>
      </div>
